...
require (
	...
	github.com/solo-io/protoc-gen-ext v0.0.3
...
replace (
	...
	github.com/envoyproxy/protoc-gen-validate => github.com/envoyproxy/protoc-gen-validate v0.2.0-java.0.20191218162112-6d6fa03f9dc6
