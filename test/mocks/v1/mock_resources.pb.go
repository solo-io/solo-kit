...
type SimpleMockResource struct {
	...
	MappedData    map[string]string `protobuf:"bytes,10,rep,name=mapped_data,json=mappedData,proto3" json:"mapped_data,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_github_com_solo_io_solo_kit_test_mocks_api_v1_mock_resources_proto_rawDesc = []byte{
	...
	0x22, 0xf4, 0x02, 0x0a, 0x12, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x4d, 0x6f, 0x63, 0x6b, 0x52,
	...
	,
...
var file_github_com_solo_io_solo_kit_test_mocks_api_v1_mock_resources_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_github_com_solo_io_solo_kit_test_mocks_api_v1_mock_resources_proto_goTypes = []interface{}{
	...
	(*NestedOneOf_InternalOneOf)(nil), // 6: testing.solo.io.NestedOneOf.InternalOneOf
	(*core.Status)(nil),               // 7: core.solo.io.Status
	(*core.Metadata)(nil),             // 8: core.solo.io.Metadata
	(*any.Any)(nil),                   // 9: google.protobuf.Any
	(*v2.DiscoveryRequest)(nil),       // 10: envoy.api.v2.DiscoveryRequest
	(*v2.DeltaDiscoveryRequest)(nil),  // 11: envoy.api.v2.DeltaDiscoveryRequest
	(*v2.DiscoveryResponse)(nil),      // 12: envoy.api.v2.DiscoveryResponse
	(*v2.DeltaDiscoveryResponse)(nil), // 13: envoy.api.v2.DeltaDiscoveryResponse
}
var file_github_com_solo_io_solo_kit_test_mocks_api_v1_mock_resources_proto_depIdxs = []int32{
	7,  // 0: testing.solo.io.SimpleMockResource.status:type_name -> core.solo.io.Status
	8,  // 1: testing.solo.io.SimpleMockResource.metadata:type_name -> core.solo.io.Metadata
	5,  // 2: testing.solo.io.SimpleMockResource.mapped_data:type_name -> testing.solo.io.SimpleMockResource.MappedDataEntry
	7,  // 3: testing.solo.io.MockResource.status:type_name -> core.solo.io.Status
	8,  // 4: testing.solo.io.MockResource.metadata:type_name -> core.solo.io.Metadata
	9,  // 5: testing.solo.io.MockResource.any:type_name -> google.protobuf.Any
	2,  // 6: testing.solo.io.MockResource.oneof_nestedoneof:type_name -> testing.solo.io.NestedOneOf
	6,  // 7: testing.solo.io.NestedOneOf.another_nested_oneof_one:type_name -> testing.solo.io.NestedOneOf.InternalOneOf
	6,  // 8: testing.solo.io.NestedOneOf.another_nested_oneof_two:type_name -> testing.solo.io.NestedOneOf.InternalOneOf
	8,  // 9: testing.solo.io.FakeResource.metadata:type_name -> core.solo.io.Metadata
	10, // 10: testing.solo.io.MockXdsResourceDiscoveryService.StreamMockXdsResourceConfig:input_type -> envoy.api.v2.DiscoveryRequest
	11, // 11: testing.solo.io.MockXdsResourceDiscoveryService.DeltaMockXdsResourceConfig:input_type -> envoy.api.v2.DeltaDiscoveryRequest
	10, // 12: testing.solo.io.MockXdsResourceDiscoveryService.FetchMockXdsResourceConfig:input_type -> envoy.api.v2.DiscoveryRequest
	12, // 13: testing.solo.io.MockXdsResourceDiscoveryService.StreamMockXdsResourceConfig:output_type -> envoy.api.v2.DiscoveryResponse
	13, // 14: testing.solo.io.MockXdsResourceDiscoveryService.DeltaMockXdsResourceConfig:output_type -> envoy.api.v2.DeltaDiscoveryResponse
	12, // 15: testing.solo.io.MockXdsResourceDiscoveryService.FetchMockXdsResourceConfig:output_type -> envoy.api.v2.DiscoveryResponse
...
func file_github_com_solo_io_solo_kit_test_mocks_api_v1_mock_resources_proto_init() {
	...
	file_github_com_solo_io_solo_kit_test_mocks_api_v1_mock_resources_proto_msgTypes[6].OneofWrappers = []interface{}{
