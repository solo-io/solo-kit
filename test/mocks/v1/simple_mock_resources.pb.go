...
func file_github_com_solo_io_solo_kit_test_mocks_api_v1_simple_mock_resources_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_solo_io_solo_kit_test_mocks_api_v1_simple_mock_resources_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_solo_kit_test_mocks_api_v1_simple_mock_resources_proto_msgTypes[3].Exporter = func(v any, i int) any {
