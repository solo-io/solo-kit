...
type SimpleMockResource struct {
	...
	DataWithLongComment int64 `protobuf:"varint,7,opt,name=data_with_long_comment,json=dataWithLongComment,proto3" json:"data_with_long_comment,omitempty"`
...
func (x *SimpleMockResource) GetDataWithLongComment() int64 {
	if x != nil {
...
var file_github_com_solo_io_solo_kit_test_mocks_api_v1_simple_mock_resources_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x13, 0x64, 0x61, 0x74, 0x61, 0x57, 0x69, 0x74, 0x68, 0x4c, 0x6f,
