...
func init() {
	...
	if err := json.Unmarshal([]byte(AnotherMockResourceJsonSchema), &v1beta1.JSONSchemaProps{}); err != nil {
		log.Fatalf("could not unmarshal AnotherMockResource json schema into kube json schema props")
	}
}
