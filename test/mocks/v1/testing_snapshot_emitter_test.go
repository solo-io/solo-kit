...
var _ = Describe("V1Emitter", func() {
	...
	It("tracks snapshots on changes to any resource using AllNamespace", func() {
		...
		/*
			SimpleMockResource
		*/
		simpleMockResource_list_1, _ := simpleMockResourceClient.List(namespace1, clients.ListOpts{Ctx: ctx})
		simpleMockResource_list_2, _ := simpleMockResourceClient.List(namespace2, clients.ListOpts{Ctx: ctx})
		snap = <-snapshots

		_, err = snap.Simplemocks.Find(simpleMockResource_list_1[0].GetMetadata().Ref().Strings())
		Expect(err).To(BeNil())
		_, err = snap.Simplemocks.Find(simpleMockResource_list_2[0].GetMetadata().Ref().Strings())
		Expect(err).To(BeNil())
		...
		/*
			MockResource
		*/
		mockResource_list_1, _ := mockResourceClient.List(namespace1, clients.ListOpts{Ctx: ctx})
		mockResource_list_2, _ := mockResourceClient.List(namespace2, clients.ListOpts{Ctx: ctx})
		snap = <-snapshots

		_, err = snap.Mocks.Find(mockResource_list_1[0].GetMetadata().Ref().Strings())
		Expect(err).To(BeNil())
		_, err = snap.Mocks.Find(mockResource_list_2[0].GetMetadata().Ref().Strings())
		Expect(err).To(BeNil())
		...
		/*
			FakeResource
		*/
		fakeResource_list_1, _ := fakeResourceClient.List(namespace1, clients.ListOpts{Ctx: ctx})
		fakeResource_list_2, _ := fakeResourceClient.List(namespace2, clients.ListOpts{Ctx: ctx})
		snap = <-snapshots

		_, err = snap.Fakes.Find(fakeResource_list_1[0].GetMetadata().Ref().Strings())
		Expect(err).To(BeNil())
		_, err = snap.Fakes.Find(fakeResource_list_2[0].GetMetadata().Ref().Strings())
		Expect(err).To(BeNil())
		...
		/*
			AnotherMockResource
		*/
		anotherMockResource_list_1, _ := anotherMockResourceClient.List(namespace1, clients.ListOpts{Ctx: ctx})
		anotherMockResource_list_2, _ := anotherMockResourceClient.List(namespace2, clients.ListOpts{Ctx: ctx})
		snap = <-snapshots

		_, err = snap.Anothermockresources.Find(anotherMockResource_list_1[0].GetMetadata().Ref().Strings())
		Expect(err).To(BeNil())
		_, err = snap.Anothermockresources.Find(anotherMockResource_list_2[0].GetMetadata().Ref().Strings())
		Expect(err).To(BeNil())
		...
		/*
			ClusterResource
		*/
		clusterResource_list_1, _ := clusterResourceClient.List(namespace1, clients.ListOpts{Ctx: ctx})
		clusterResource_list_2, _ := clusterResourceClient.List(namespace2, clients.ListOpts{Ctx: ctx})
		snap = <-snapshots

		_, err = snap.Clusterresources.Find(clusterResource_list_1[0].GetMetadata().Ref().Strings())
		Expect(err).To(BeNil())
		_, err = snap.Clusterresources.Find(clusterResource_list_2[0].GetMetadata().Ref().Strings())
		Expect(err).To(BeNil())
		...
		/*
			MockCustomType
		*/
		mockCustomType_list_1, _ := mockCustomTypeClient.List(namespace1, clients.ListOpts{Ctx: ctx})
		mockCustomType_list_2, _ := mockCustomTypeClient.List(namespace2, clients.ListOpts{Ctx: ctx})
		snap = <-snapshots

		_, err = snap.Mcts.Find(mockCustomType_list_1[0].GetMetadata().Ref().Strings())
		Expect(err).To(BeNil())
		_, err = snap.Mcts.Find(mockCustomType_list_2[0].GetMetadata().Ref().Strings())
		Expect(err).To(BeNil())
		...
		/*
			Pod
		*/
		pod_list_1, _ := podClient.List(namespace1, clients.ListOpts{Ctx: ctx})
		pod_list_2, _ := podClient.List(namespace2, clients.ListOpts{Ctx: ctx})
		snap = <-snapshots

		_, err = snap.Pods.Find(pod_list_1[0].GetMetadata().Ref().Strings())
		Expect(err).To(BeNil())
		_, err = snap.Pods.Find(pod_list_2[0].GetMetadata().Ref().Strings())
		Expect(err).To(BeNil())
