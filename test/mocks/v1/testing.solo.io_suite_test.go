...
var (
	...
	_ = SynchronizedAfterSuite(func() {}, func() {
		...
		testutils.ErrorNotOccuredOrNotFound(err)
		err = clientset.ApiextensionsV1beta1().CustomResourceDefinitions().Delete("donotgeneratedocsforme.testing.solo.io", &metav1.DeleteOptions{})
		testutils.ErrorNotOccuredOrNotFound(err)
		...
		testutils.ErrorNotOccuredOrNotFound(err)
		err = clientset.ApiextensionsV1beta1().CustomResourceDefinitions().Delete("generatedocsforme.testing.solo.io", &metav1.DeleteOptions{})
		testutils.ErrorNotOccuredOrNotFound(err)
