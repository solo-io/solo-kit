...
func ClusterResourceMultiClusterClientWatchAggregationTest(client ClusterResourceMultiClusterClient, aggregator wrapper.WatchAggregator, namespace string) {
