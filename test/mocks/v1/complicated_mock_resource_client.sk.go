...
func NewComplicatedMockResourceClient(ctx context.Context, rcFactory factory.ResourceClientFactory) (ComplicatedMockResourceClient, error) {
	return NewComplicatedMockResourceClientWithToken(ctx, rcFactory, "")
}

func NewComplicatedMockResourceClientWithToken(ctx context.Context, rcFactory factory.ResourceClientFactory, token string) (ComplicatedMockResourceClient, error) {
	...
	go func() {
		for {
			...
			case resourceList := <-resourcesChan:
				select {
				case complicatedmockresourcesChan <- convertToComplicatedMockResource(resourceList):
				case <-opts.Ctx.Done():
