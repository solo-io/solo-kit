...
func init() {
	...
	if err := json.Unmarshal([]byte(ClusterResourceJsonSchema), &v1beta1.JSONSchemaProps{}); err != nil {
		log.Fatalf("could not unmarshal ClusterResource json schema into kube json schema props")
	}
}
