...
func (r *ClusterResource) SetNamespacedStatuses(status *core.NamespacedStatuses) {
	r.StatusOneof = &ClusterResource_NamespacedStatuses{NamespacedStatuses: status}
}
...
func (r *ClusterResource) UpsertNamespacedStatus(status *core.Status) error {
