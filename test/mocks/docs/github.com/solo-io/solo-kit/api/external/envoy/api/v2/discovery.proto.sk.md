...
| `errorDetail` | [.google.rpc.Status](../../../google/rpc/status.proto.sk.md#Status) | This is populated when the previous :ref:`DiscoveryResponse <envoy_api_msg_DiscoveryResponse>` failed to update configuration. The *message* field in *error_details* provides the Envoy internal exception related to the failure. |  |




---
### <a name=DeltaDiscoveryResponse>DeltaDiscoveryResponse</a>
