	...
	It("tracks snapshots on changes to any resource using AllNamespace", func() {
		...
		*/
		...
		/*
			FrequentlyChangingAnnotationsResource
		*/
		frequentlyChangingAnnotationsResource_list_1, _ := frequentlyChangingAnnotationsResourceClient.List(namespace1, clients.ListOpts{Ctx: ctx})
		frequentlyChangingAnnotationsResource_list_2, _ := frequentlyChangingAnnotationsResourceClient.List(namespace2, clients.ListOpts{Ctx: ctx})
		snap = <-snapshots

		_, err = snap.Fcars.Find(frequentlyChangingAnnotationsResource_list_1[0].GetMetadata().Ref().Strings())
		Expect(err).To(BeNil())
		_, err = snap.Fcars.Find(frequentlyChangingAnnotationsResource_list_2[0].GetMetadata().Ref().Strings())
		Expect(err).To(BeNil())
