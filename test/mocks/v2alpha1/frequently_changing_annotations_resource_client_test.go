...
var _ = Describe("FrequentlyChangingAnnotationsResourceClient", func() {
	...
	for _, test := range []typed.ResourceClientTester{
		...
		Context("resource client backed by "+test.Description(), func() {
			var (
				client              FrequentlyChangingAnnotationsResourceClient
				err                 error
...
func FrequentlyChangingAnnotationsResourceClientTest(namespace string, client FrequentlyChangingAnnotationsResourceClient, name1, name2, name3 string) {
	...
	ExpectWithOffset(testOffset, r1).To(BeAssignableToTypeOf(&FrequentlyChangingAnnotationsResource{}))
