...
func NewFrequentlyChangingAnnotationsResourceClient(ctx context.Context, rcFactory factory.ResourceClientFactory) (FrequentlyChangingAnnotationsResourceClient, error) {
	return NewFrequentlyChangingAnnotationsResourceClientWithToken(ctx, rcFactory, "")
}
...
func (client *frequentlyChangingAnnotationsResourceClient) RegisterNamespace(namespace string) error {
