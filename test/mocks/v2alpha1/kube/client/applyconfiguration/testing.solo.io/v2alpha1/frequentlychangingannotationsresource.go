...
// FrequentlyChangingAnnotationsResourceApplyConfiguration represents an declarative configuration of the FrequentlyChangingAnnotationsResource type for use
// with apply.
type FrequentlyChangingAnnotationsResourceApplyConfiguration struct {
	v1.TypeMetaApplyConfiguration    `json:",inline"`
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *v2alpha1.FrequentlyChangingAnnotationsResource `json:"spec,omitempty"`
}

// FrequentlyChangingAnnotationsResource constructs an declarative configuration of the FrequentlyChangingAnnotationsResource type for use with
// apply.
func FrequentlyChangingAnnotationsResource(name, namespace string) *FrequentlyChangingAnnotationsResourceApplyConfiguration {
	b := &FrequentlyChangingAnnotationsResourceApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("FrequentlyChangingAnnotationsResource")
	b.WithAPIVersion("testing.solo.io/v2alpha1")
	return b
}
...
func (b *FrequentlyChangingAnnotationsResourceApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
