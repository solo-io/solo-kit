...
// MockResourceApplyConfiguration represents an declarative configuration of the MockResource type for use
// with apply.
type MockResourceApplyConfiguration struct {
	v1.TypeMetaApplyConfiguration    `json:",inline"`
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *v2alpha1.MockResource   `json:"spec,omitempty"`
	Status                           *core.NamespacedStatuses `json:"status,omitempty"`
}

// MockResource constructs an declarative configuration of the MockResource type for use with
// apply.
func MockResource(name, namespace string) *MockResourceApplyConfiguration {
	b := &MockResourceApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("MockResource")
...
func (b *MockResourceApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
