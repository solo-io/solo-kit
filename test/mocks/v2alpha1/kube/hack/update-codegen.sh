...
readonly ROOT_PKG=github.com/solo-io/solo-kit/test/mocks/v2alpha1
...
do
    PROJECT_INPUT_DIRS_SPACE+="${APIS_PKG}/testing.solo.io/v2alpha1 "
    PROJECT_INPUT_DIRS_COMMA+="${APIS_PKG}/testing.solo.io/v2alpha1,"
done
