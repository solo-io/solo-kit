...
func GenerateFiles(project *model.Project, skipOutOfPackageFiles bool) (model.Files, error) {
...
func generateFilesForXdsResource(resource *model.XDSResource) (model.Files, error) {
	var v model.Files
...
func generateFilesForResource(resource *model.Resource) (model.Files, error) {
	var v model.Files
	for suffix, tmpl := range map[string]*template.Template{
...
func generateFilesForResourceGroup(rg *model.ResourceGroup) (model.Files, error) {
	var v model.Files
	for suffix, tmpl := range map[string]*template.Template{
