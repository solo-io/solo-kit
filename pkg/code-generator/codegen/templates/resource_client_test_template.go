...
var ResourceClientTestTemplate = template.Must(template.New("resource_client_test").Funcs(Funcs).Parse(`//Generated by pkg/code-generator/codegen/templates/resource_client_test_template.go
// +build solokit
