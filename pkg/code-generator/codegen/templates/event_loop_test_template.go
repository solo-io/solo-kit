...
var ResourceGroupEventLoopTestTemplate = template.Must(template.New("resource_group_event_loop_test").Funcs(Funcs).Parse(`//Source: pkg/code-generator/codegen/templates/event_loop_test_template.go
// +build solokit
