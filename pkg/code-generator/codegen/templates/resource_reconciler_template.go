...
var ResourceReconcilerTemplate = template.Must(template.New("resource_client").Funcs(Funcs).Parse(`//Generated by pkg/code-generator/codegen/templates/resource_reconciler_template.go
