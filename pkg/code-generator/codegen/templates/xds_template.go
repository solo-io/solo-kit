...
var XdsTemplate = template.Must(template.New("xds_template").Funcs(Funcs).Parse(`//Source: pkg/code-generator/codegen/templates/test_suite_template.go
...
const {{ upper_camel .MessageType }}Type = types.TypePrefix + "/{{ .ProtoPackage }}.{{ upper_camel .MessageType }}"
