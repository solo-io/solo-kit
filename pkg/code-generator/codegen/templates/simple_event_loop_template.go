...
var SimpleEventLoopTemplate = template.Must(template.New("simple_event_loop").Funcs(Funcs).Parse(`//Source: pkg/code-generator/codegen/templates/simple_event_loop_template.go
