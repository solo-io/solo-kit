...
var SimpleEventLoopTemplate = template.Must(template.New("simple_event_loop").Funcs(Funcs).Parse(`//Generated by pkg/code-generator/codegen/templates/simple_event_loop_template.go
