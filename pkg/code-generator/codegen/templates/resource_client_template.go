...
var ResourceClientTemplate = template.Must(template.New("resource_reconciler").Funcs(Funcs).Parse(`//Source: pkg/code-generator/codegen/templates/resource_client_template.go
