...
var ResourceGroupEmitterTemplate = template.Must(template.New("resource_group_emitter").Funcs(Funcs).Parse(`//Generated by pkg/code-generator/codegen/templates/snapshot_emitter_template.go
