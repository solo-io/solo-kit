...
var ResourceGroupEmitterTestTemplate = template.Must(template.New("resource_group_emitter_test").Funcs(Funcs).Parse(`//Generated by pkg/code-generator/codegen/templates/snapshot_emitter_test_template.go
// +build solokit
