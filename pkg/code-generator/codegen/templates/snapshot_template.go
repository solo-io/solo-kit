...
var ResourceGroupSnapshotTemplate = template.Must(template.New("resource_group_snapshot").Funcs(Funcs).Parse(`//Generated by pkg/code-generator/codegen/templates/snapshot_template.go
