...
var ProjectTestSuiteTemplate = template.Must(template.New("project_template").Funcs(Funcs).Parse(`//Generated by pkg/code-generator/codegen/templates/test_suite_template.go
