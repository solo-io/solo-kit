...
type Node struct {
	...
	//
	// Deprecated: Marked as deprecated in github.com/solo-io/solo-kit/api/external/envoy/api/v2/core/base.proto.
...
var file_github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_proto_rawDesc = []byte{
	...
	0x0c, 0x0a, 0x08, 0x4f, 0x55, 0x54, 0x42, 0x4f, 0x55, 0x4e, 0x44, 0x10, 0x02, 0x42, 0x82, 0x01,
	0xb8, 0xf5, 0x04, 0x01, 0xc0, 0xf5, 0x04, 0x01, 0xd0, 0xf5, 0x04, 0x01, 0x0a, 0x27, 0x69, 0x6f,
	...
	0x2e, 0x63, 0x6f, 0x72, 0x65, 0x42, 0x09, 0x42, 0x61, 0x73, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f,
...
var file_github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_proto_goTypes = []any{
...
func file_github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Node); i {
			case 0:
				return &v.state
			case 1:
		...
		file_github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_proto_msgTypes[12].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_proto_msgTypes[13].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_proto_msgTypes[14].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_proto_msgTypes[15].Exporter = func(v any, i int) any {
	...
	file_github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_proto_msgTypes[3].OneofWrappers = []any{
		(*Node_UserAgentVersion)(nil),
		(*Node_UserAgentBuildVersion)(nil),
	}
	file_github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_proto_msgTypes[8].OneofWrappers = []any{
		(*HeaderValueOption_Header)(nil),
		(*HeaderValueOption_HeaderSecretRef)(nil),
	}
	file_github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_proto_msgTypes[10].OneofWrappers = []any{
		(*DataSource_Filename)(nil),
		(*DataSource_InlineBytes)(nil),
		(*DataSource_InlineString)(nil),
	}
	file_github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_proto_msgTypes[12].OneofWrappers = []any{
		(*AsyncDataSource_Local)(nil),
		(*AsyncDataSource_Remote)(nil),
	}
	file_github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_proto_msgTypes[13].OneofWrappers = []any{
