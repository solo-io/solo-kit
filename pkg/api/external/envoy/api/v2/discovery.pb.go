...
// source: solo-kit/api/external/envoy/api/v2/discovery.proto
...
func (*DiscoveryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6340e51aadbe3db, []int{0}
}
...
func (*DiscoveryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6340e51aadbe3db, []int{1}
}
...
func (*DeltaDiscoveryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6340e51aadbe3db, []int{2}
}
...
func (*DeltaDiscoveryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6340e51aadbe3db, []int{3}
}
...
func (*Resource) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6340e51aadbe3db, []int{4}
}
...
func init() {
	proto.RegisterFile("solo-kit/api/external/envoy/api/v2/discovery.proto", fileDescriptor_f6340e51aadbe3db)
}

var fileDescriptor_f6340e51aadbe3db = []byte{
	...
	,
}
