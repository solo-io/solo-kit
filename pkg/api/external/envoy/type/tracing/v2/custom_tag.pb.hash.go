...
func (m *CustomTag) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.type.tracing.v2.github.com/solo-io/solo-kit/pkg/api/external/envoy/type/tracing/v2.CustomTag")); err != nil {
		return 0, err
	}
...
func (m *CustomTag_Literal) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.type.tracing.v2.github.com/solo-io/solo-kit/pkg/api/external/envoy/type/tracing/v2.CustomTag_Literal")); err != nil {
		return 0, err
	}
...
func (m *CustomTag_Environment) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.type.tracing.v2.github.com/solo-io/solo-kit/pkg/api/external/envoy/type/tracing/v2.CustomTag_Environment")); err != nil {
		return 0, err
	}
...
func (m *CustomTag_Header) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.type.tracing.v2.github.com/solo-io/solo-kit/pkg/api/external/envoy/type/tracing/v2.CustomTag_Header")); err != nil {
		return 0, err
	}
...
func (m *CustomTag_Metadata) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.type.tracing.v2.github.com/solo-io/solo-kit/pkg/api/external/envoy/type/tracing/v2.CustomTag_Metadata")); err != nil {
		return 0, err
	}
