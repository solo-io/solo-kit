...
var (
	...
	_ = SynchronizedAfterSuite(func() {}, func() {
		...
		Expect(err).NotTo(HaveOccurred())
		err = clientset.ApiextensionsV1beta1().CustomResourceDefinitions().Delete("anothermockresources.testing.solo.io.v2alpha1", &metav1.DeleteOptions{})
		testutils.ErrorNotOccuredOrNotFound(err)
		err = clientset.ApiextensionsV1beta1().CustomResourceDefinitions().Delete("clusterresources.testing.solo.io.v2alpha1", &metav1.DeleteOptions{})
		testutils.ErrorNotOccuredOrNotFound(err)
		err = clientset.ApiextensionsV1beta1().CustomResourceDefinitions().Delete("fakes.testing.solo.io.v2alpha1", &metav1.DeleteOptions{})
		testutils.ErrorNotOccuredOrNotFound(err)
