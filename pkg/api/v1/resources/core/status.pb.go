...
type Status struct {
	...
	SubresourceStatuses map[string]*Status_SubStatus `protobuf:"bytes,4,rep,name=subresource_statuses,json=subresourceStatuses,proto3" json:"subresource_statuses,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (x *Status) GetSubresourceStatuses() map[string]*Status_SubStatus {
	if x != nil {
...
type Status_SubStatus struct {
	...
	ReportedBy string `protobuf:"bytes,3,opt,name=reported_by,json=reportedBy,proto3" json:"reported_by,omitempty"`
	// Opaque details about status results
	Details *_struct.Struct `protobuf:"bytes,4,opt,name=details,proto3" json:"details,omitempty"`
}

func (x *Status_SubStatus) Reset() {
	*x = Status_SubStatus{}
	if protoimpl.UnsafeEnabled {
...
func (x *Status_SubStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Status_SubStatus) ProtoMessage() {}

func (x *Status_SubStatus) ProtoReflect() protoreflect.Message {
	mi := &file_status_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Status_SubStatus.ProtoReflect.Descriptor instead.
func (*Status_SubStatus) Descriptor() ([]byte, []int) {
	return file_status_proto_rawDescGZIP(), []int{0, 0}
}

func (x *Status_SubStatus) GetState() Status_State {
	if x != nil {
		return x.State
	}
	return Status_Pending
...
func (x *Status_SubStatus) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
func (x *Status_SubStatus) GetReportedBy() string {
	if x != nil {
		return x.ReportedBy
	}
	return ""
...
func (x *Status_SubStatus) GetDetails() *_struct.Struct {
	if x != nil {
		return x.Details
	}
	return nil
...
var file_status_proto_rawDesc = []byte{
	...
	0x66, 0x2f, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xdb,
	0x04, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x30, 0x0a, 0x05, 0x73, 0x74, 0x61,
	...
	0x52, 0x07, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x1a, 0xa9, 0x01, 0x0a, 0x09, 0x53, 0x75,
	0x62, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x30, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65,
	...
	,
	...
	0x0b, 0x0a, 0x07, 0x57, 0x61, 0x72, 0x6e, 0x69, 0x6e, 0x67, 0x10, 0x03, 0x42, 0x3f, 0x5a, 0x35,
...
var file_status_proto_goTypes = []interface{}{
	...
	(*Status_SubStatus)(nil), // 2: core.solo.io.Status.SubStatus
	nil,                      // 3: core.solo.io.Status.SubresourceStatusesEntry
	(*_struct.Struct)(nil),   // 4: google.protobuf.Struct
}
var file_status_proto_depIdxs = []int32{
	0, // 0: core.solo.io.Status.state:type_name -> core.solo.io.Status.State
	3, // 1: core.solo.io.Status.subresource_statuses:type_name -> core.solo.io.Status.SubresourceStatusesEntry
	4, // 2: core.solo.io.Status.details:type_name -> google.protobuf.Struct
	0, // 3: core.solo.io.Status.SubStatus.state:type_name -> core.solo.io.Status.State
	4, // 4: core.solo.io.Status.SubStatus.details:type_name -> google.protobuf.Struct
	2, // 5: core.solo.io.Status.SubresourceStatusesEntry.value:type_name -> core.solo.io.Status.SubStatus
