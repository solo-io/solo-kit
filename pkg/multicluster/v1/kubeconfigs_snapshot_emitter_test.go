...
var _ = Describe("V1Emitter", func() {
	...
	It("tracks snapshots on changes to any resource using AllNamespace", func() {
		...
		/*
			KubeConfig
		*/
		kubeConfig_list_1, _ := kubeConfigClient.List(namespace1, clients.ListOpts{Ctx: ctx})
		kubeConfig_list_2, _ := kubeConfigClient.List(namespace2, clients.ListOpts{Ctx: ctx})
		snap = <-snapshots

		_, err = snap.Kubeconfigs.Find(kubeConfig_list_1[0].GetMetadata().Ref().Strings())
		Expect(err).To(BeNil())
		_, err = snap.Kubeconfigs.Find(kubeConfig_list_2[0].GetMetadata().Ref().Strings())
		Expect(err).To(BeNil())
