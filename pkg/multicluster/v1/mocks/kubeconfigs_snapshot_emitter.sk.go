...
func (m *MockKubeconfigsEmitter) KubeConfig() v1.KubeConfigWatcher {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "KubeConfig")
	ret0, _ := ret[0].(v1.KubeConfigWatcher)
	return ret0
}
...
func (m *MockKubeconfigsEmitter) Snapshots(watchNamespaces *clients.NamespacesByResourceWatcher, opts clients.WatchOpts) (<-chan *v1.KubeconfigsSnapshot, <-chan error, error) {
	m.ctrl.T.Helper()
